...
//  function 
  ...
  for(const id of Object.keys(results)){
    console.log('...............',results[id._id].topic);
    const body = {
      query: {
        dis_max: {
          queries: [
            {
              terms: {
                topic_id: `${results[id._id].topic}`
              }
            },
            {
              terms: {
                sub_id: `${results[id._id].courseType}`
              }
            },
            {
              terms: {
                author_id: `${results[id._id].curator}`
              }
            }
          ]
        }
    ...
    toQuery.push(client.search({
      ...
      body: body,
      '_source': ['type', 'author', 'type', 'title', 'metaInformation.subject.name', 'thumbnail']}));
      if (results[id._id] === '59e462c64a42a91ef5f4d8d0,') console.log('printing array toQuery..................................................',JSON.stringify(body,null,2));
  }
