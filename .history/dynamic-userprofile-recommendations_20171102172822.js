...
async function sendEmail(){
  ...
  for (user of fetchedCourses){
    const { hits } = fetchedCourses[user].hits;
    for( index of hits.hits){
      const { _source} = fetchedCourses[user].hits[index]._source;
      collectedResults.push(_source);
    }
  }
  
  console.log('collectedResults........................',collectedResults);
